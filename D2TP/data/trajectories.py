...
class TrajectoryDataset(Dataset):
    ...
    def __init__(
        ...
        # 4 个交通灯的固定坐标。
        self.light_pos=torch.tensor([[522,599],[1063,860],[1381,489],[940,208]])
        self.time_top=torch.tensor([38,47,2])
        # 4 个状态通道：灯位置 x/y、灯态编号、灯态持续时间。
